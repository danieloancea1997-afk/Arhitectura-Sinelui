...
const courseTitle = 'Neurobiologia și Psihologia Adicției: O Abordare Integrativă'
      ...
      <div className="courses-content">
        ...
        <div className="card courses-card">
          ...
          <div className="courses-module">
            <h4>Modul I - Ce este adictia? Definitii si perspective neurobiologice</h4>
            <ul>
              <li>1.1. Definitia si tipuri de adictie</li>
              <li>1.2. Neurobiologia Recompensei si Neuroplasticitatea</li>
              <li>1.3. Homeostaza Alostaza si Procese Opuse</li>
            </ul>
          </div>
          ...
          <div className="courses-module">
            ...
            <ul>
              ...
              <li>
                2.3. „Să numim corect durerea” trauma în perspectiva lui Gabor Maté și legătura cu
                adicția
              </li>
              <li>2.4. „Esentialul care rămâne” repere-ancoră pentru tot modulul</li>
            </ul>
          </div>

          <div className="courses-module">
            <h4>
              Modul III - Perspectiva psihologică și transpersonală: sensul mai profund al adicției
            </h4>
            <ul>
              <li>
              ...
              <li>3.2 - Psihologia Transpersonala</li>
              <li>3.3 - Adicția ca și „criză psihospirituală”</li>
          ...
          <div className="courses-module">
            ...
            <p>
              ...
              ne arată unde anume pe hartă mai avem de lucrat. Trecem de la rușinea care blochează,
              la responsabilitatea blândă care reconstruiește.
            </p>
          </div>
